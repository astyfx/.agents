...
echo ""
echo "--- Orchestration & connector docs (Phase 6) ---"
check "workflows-and-orchestration playbook" "[[ -f '${REPO_DIR}/memory/playbooks/workflows-and-orchestration.md' ]]"
check "scheduled-and-background-agents playbook" "[[ -f '${REPO_DIR}/memory/playbooks/scheduled-and-background-agents.md' ]]"
check "connectors-and-plugins playbook" "[[ -f '${REPO_DIR}/memory/playbooks/connectors-and-plugins.md' ]]"
check "ROUTING.md references workflows playbook" "grep -q 'workflows-and-orchestration.md' '${REPO_DIR}/docs/instructions/ROUTING.md'"
check "ROUTING.md references scheduled-agents playbook" "grep -q 'scheduled-and-background-agents.md' '${REPO_DIR}/docs/instructions/ROUTING.md'"
check "CONTEXT_LOADING references connectors playbook" "grep -q 'connectors-and-plugins.md' '${REPO_DIR}/docs/instructions/CONTEXT_LOADING.md'"
check "AGENTS.md has Orchestration Default pointer" "grep -q 'Orchestration Default' '${REPO_DIR}/AGENTS.md'"
...
check "init-repo.sh supports --with-ralph-codex" "grep -q -- '--with-ralph-codex' '${REPO_DIR}/scripts/init-repo.sh'"
...
check "scaffold-ralph-codex.sh" "[[ -f '${REPO_DIR}/scripts/scaffold-ralph-codex.sh' ]]"
check "scaffold-ralph-codex.sh is executable" "[[ -x '${REPO_DIR}/scripts/scaffold-ralph-codex.sh' ]]"
