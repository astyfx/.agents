...
description: 'Diagnose and fix build failures, TypeScript errors, CI failures, and dependency issues. Use when the user pastes error output from tsc, bun build, vitest, eslint, or CI logs, or says "빌드 실패", "CI failed", "tsc error", "build is broken", "fix this error".'
