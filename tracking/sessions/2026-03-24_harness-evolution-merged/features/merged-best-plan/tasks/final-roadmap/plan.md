...
- Codex plan: `tracking/sessions/2026-03-24_harness-evolution-research/...`
...
| New utility scripts    | hooks scripts only                     | new-tracked-task.sh + check-harness.sh | **Codex** — both scripts are high value |
...
### 2-4. `scripts/new-tracked-task.sh` (from Codex plan)
...
# tracking/sessions/YYYY-MM-DD_<session>/features/<feature>/tasks/<task>/
